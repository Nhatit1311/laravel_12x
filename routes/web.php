...
Route::get('/data-chuyen-muc', [TrangChuController::class, 'data'])->name('dataChuyenMucHomePage');
...
Route::group(['middleware' => 'user'], function() {
    ...
    Route::get('/dia-chi/data', [CustomerController::class, 'dataDiaChi'])->name('dataCustomerAddress');
    Route::get('/don-hang', [CustomerController::class, 'viewDonHang'])->name('viewCustomerOrder');
    Route::get('/don-hang/data-user', [CustomerController::class, 'dataCustomerOrder'])->name('dataCustomerOrder');
