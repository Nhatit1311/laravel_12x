                    ...
                    <div class="categories__menu ">
                        ...
                        <div class="dropdown__categories--menu border-radius-5 active collapse {{ Route::is('HomePageUser') ? 'show' : '' }}"
                            ...
                            <ul class="d-none d-lg-block">
                                <template v-for="(key, value) in list_chuyen_muc">
                                    <li v-if="value.id_chuyen_muc_cha ==0"
                                        ...
                                        <ul class="categories__submenu border-radius-10">
                                            <li class="categories__submenu--items">
                                                <template v-for="(key1, value1) in list_chuyen_muc">
                                                    <ul v-if="value.id == value1.id_chuyen_muc_cha"
                                                        class="categories__submenu--child">
                                                        <li class="categories__submenu--child__items"><a
                                                                class="categories__submenu--child__items--link"
                                                                :href="`/product/${value1.id}`">@{{ value1.ten_chuyen_muc }} </a></li>
                                                    </ul>
                                                </template>
                                            </li>
                                        </ul>
        ...
        $(document).ready(function() {
            new Vue({
                ...
                methods: {
                    loadDataChuyenMuc() {
                        axios
                            .get('{{ Route('dataChuyenMucHomePage') }}')
                            .then((res) => {
